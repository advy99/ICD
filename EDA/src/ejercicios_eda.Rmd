...
Para esto utilizaremos la función `cor` para obtener la matriz de correlación, además de utilizar el gráfico `pairs` para graficar todas las variables entre si.

```{r}
# nos quedamos solo con las numericas
cor(Carseats %>% select_if(is.numeric))

pairs(Carseats %>% select_if(is.numeric))
```
